...
@endsection
@section('form')
  <form action="/experience/1-0" method="post" id="display">
    {{ csrf_field() }}
  <input id="input" type="hidden" name="score">
  <input id="input_damage" type="hidden" name="damage" value="100">
  <input id="input_atack" type="hidden" name="atack" value="50">
  <input id="input_defense" type="hidden" name="defense" value="50">
  <input id="input_experiense" type="hidden" name="experience" value="0">
  <input id="input_character" type="hidden" name="chara" value="A">
  <input id="input_image" type="hidden" name="url" value="/img/majic_effect2-1.gif">
  <input id="stage_atack" type="hidden" name="stage_atack" value="0">
