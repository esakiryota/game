...
@section('title', '生徒')
@section('background', '/img/start-bg-land.jpg')
...
<div class="container">
  ...
  <div class="row my-3">
   <div class="doors col-4 text-center" id="english"><a href="/user/english_training_0" id="searchLink"><img src="/img/pointer.png" class="w-50" id="doortmp"></a></div>
