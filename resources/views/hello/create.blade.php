...
<html lang="ja" dir="ltr">
  ...
  <body>
    <div class="conteiner mx-5">
      <div class="row my-5">
        <div class="col">
          <h1 style="font-size: 60px;">アカウントをつくる</h1>
        </div>
      </div>
        <form  action="/create" method="post" id="form_control">
          {{ csrf_field() }}
      ...
      <!-- <div class="row">
        <div class="col form-group">
          ...
          <input type="password" class="form-control" placeholder="ID" id="indent" style="height: 100px; font-size: 50px;">
        </div>
      </div> -->
      <div class="row my-4">
            <div class="col">
