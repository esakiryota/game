            ...
            <div class="card" style="box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.5);">
                ...
                <div class="card-body">
                    <form class="" method="POST" action="{{ route('contact') }}">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('返信用メールアドレス') }}</label>

                            <div class="col-md-6">
                                <input id="return_address" type="text" class="form-control" name="return_address" required autocomplete="email" autofocus>
                            </div>
                        </div>
